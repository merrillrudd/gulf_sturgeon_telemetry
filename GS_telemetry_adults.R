...
###############################################
out_dir <- file.path(init_dir, "adults_only")
...
transmitters <- compile_transmitters(raw_dir=data_raw_dir, adj_dir=inputs_csv, adults=TRUE, juveniles=FALSE, exclude=exclude_trans)
